...
# SCRIPT NAME: mash_square.sh
# DESCRIPTION: This script creates a mash square from an input set of fasta files.
# 
...
mash dist "$BIOSUITE_HOME"/databases/"$db_name".msh "$BIOSUITE_HOME"/databases/"$db_name".msh | square_mash > "$mash_output"