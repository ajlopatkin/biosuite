...
This script is the fourth step of Bacsort. It takes no arguments. When run, it loads the tree
...
def load_cluster_accessions():
    ...
    with open('cluster_accessions', 'rt') as accessions_file:
        for line in accessions_file:
            ...
            accessions = [x.split('.fna.gz')[0].split("/")[-1] for x in parts[1].split(',')]
